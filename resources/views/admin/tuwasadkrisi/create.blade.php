...
@endif
<form action="{{ route('tuwakrishis.store') }}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('post')
  <div class="row ">
  ...
  <div class="form-floating mt-2 col col-md-4">
      <input type="text" name="title" class="form-control" id="floatingInput" placeholder="adress">
