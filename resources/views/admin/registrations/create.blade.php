...
<form action="{{ route('registrations.store') }}" method="POST">
  @csrf
  <div class="row ">
    <h1 class="h3 mb-3 fw-normal mt-3"><label for="">Registration</label></h1>
  </div>
   <div class="row">
   <div class="form-floating mt-2 col col-md-4">
    ...
    <div class="form-floating mt-2 col col-md-4">
      <input type="text" name="account_no" class="form-control @error ('account_no') is-invalid @enderror" id="floatingInput" placeholder="name.com">
      <label for="floatingInput">Account_no</label>
    </div>
    <div class="form-floating mt-2 col col-md-4">
      <input type="text" name="account_types" class="form-control @error ('account_types') is-invalid @enderror" id="floatingInput" placeholder="">
      <label for="">Account_types</label>
    </div>
   </div>
   <div class="row">
   <div class="form-floating mt-2 col col-md-4">
      <input type="number" name="phone_number" class="form-control @error ('phone_number') is-invalid @enderror" id="floatingInput" placeholder="Password">
      <label for="floatingInput">Phone Number</label>
    </div>
    <div class="form-floating mt-2 col col-md-4">
      <input type="date" name="file_jomar_date" class="form-control" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput">file_jomar_date</label>
    </div>
    <div class="form-floating mt-2 col col-md-4">
   ...
   <div class="form-floating mt-2 col col-md-4">
    ...
    <div class="form-floating mt-2 col col-md-4">
      <input type="date" name="account_open_date" class="form-control" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput">account_open_date</label>
    </div>
   </div>
   <div class="row">
    <div class="form-floating mt-2 col col-md-4">
      <input type="text" name="comment" class="form-control" id="floatingInput" placeholder="Password">
