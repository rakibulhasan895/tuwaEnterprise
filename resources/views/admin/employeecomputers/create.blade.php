...
@endif
<form action="{{ route('employeecomputers.store') }}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('post')
  <div class="row ">
  ...
  <div class="form-floating mt-2 col col-md-4">
   ...
   <div class="form-floating mt-2 col col-md-4">
    ...
    <div class="form-floating mt-2 col">
      <input type="textarea" name="personal_details" class="form-control" id="floatingInput" placeholder="Blog">
